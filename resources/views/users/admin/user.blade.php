<x-app-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 justify-beetwen mx-auto">
        <img class="h-auto rounded-lg" src="/assets/img/user1.jpg" alt="photo de profil ">
        <div class="flex flex-col space-y-4">
            <h2 class="text-xl font-bold mb-4">Détails du personnel</h2><ul class="space-y-4">
                ...
                <li class="flex justify-between">
                    ...
                    <span class="text-gray-600">123 Rue Exemple, Ville, Pays</span>
                </li>
            </ul>
            <div class="mx-auto">
